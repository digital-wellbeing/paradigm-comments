...
authornote: |
  A non-peer reviewed pre-print of this work is available at <https://psyarxiv.com/dpuya>.
...
With all of this in mind, we underscore the valuable and collegial exchanges we have had with the authors whose work we are here critiquing [@johannesHowShouldWe2021a; @valkenburgHowAssessVariation2022]. The stakes for understanding well-being in the digital age are simply too high for personal acrimony or ideological fiefdoms. To break the current impasse, three points should be widely acknowledged and integrated into our collective research practices:
...
This study does not report original data, but reanalyses data reported and made available in Beyens et al. [-@beyensEffectSocialMedia2020; -@Beyens2021].
